...
export const USER_REVENUE_STAT_SCR = 'UserRevenueStat'
...
export const USER_PAYMENT_SCR = 'UserPayments'
export const POST_TURN_SERVICES_SCR = 'PostTurnServices'
...
export const ADMIN_DETAILS_SCR = 'AdminDetailsManager'
export const ADMIN_SERVICE_SCR = 'AdminServiceManager'
